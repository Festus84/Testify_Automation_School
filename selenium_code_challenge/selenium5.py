...
def main():
    ...
    driver.get("https://www.youtube.com/watch?v=JmYFrFSeKpg")
    time.sleep(20)
    # youTube_play_button = driver.find_element(By.XPATH, '//*[@id="movie_player"]/div[33]/div[2]/div[1]/button')
    # youTube_play_button.click()
    # time.sleep(5)
    first_comment = driver.find_element(By.CLASS_NAME, "style-scope yt-formatted-string")
    print("First Comment:", first_comment, first_comment.text)
    time.sleep(5)
    second_comment = driver.find_element(By.ID, "content-text")
